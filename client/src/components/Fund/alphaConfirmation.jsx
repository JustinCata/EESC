...
class AlphaConfirmation extends Component {
    constructor(){
        super();
    }
    ...
    return  <div className="conf-container">
                ...
                <p> <a href={ 'iota://' + IOTAaddress + '/?amount=' + (this.props.miotaPrice*1000000).toFixed(0) + '&message=' + this.props.tag } target="_blank"> Open with Trinity <span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> </a> </p>
...
export default AlphaConfirmation;
