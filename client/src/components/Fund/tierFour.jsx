...
class TierFour extends Component {
  constructor(){
    super();
    this.state = { 
      showForm : true,
  ...
  render() {
    ...
    return (
      <div id="TierFour" className="TierFour">
<Popup trigger={<div id="button" className="button">
<div className="row">
  ...
  <div className="col-xs-12 contributeDesc">
    <ul>
      ...
      <li>A 5% discount on all products purchased on Metamesh for <span className="bold">6 months</span>.</li>
      <li>Access to our closed Alpha.</li>
      <li>Access to our closed Beta.</li>
      <li>15 invites to our closed Beta.</li>
    </ul>
  </div>
  <a href="#TierFour" onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut} className="fund-cta">Contribute</a>
  </div>
</div>
