...
class TierTwo extends Component {
  ...
  render() {
    ...
    return (
      <div id="TierTwo" className="TierTwo">
...
<div className="row">
  ...
  <div className="col-xs-12 contributeDesc">
    <ul>
      ...
      <li>A 5% discount on all products purchased on Metamesh for <span className="bold">1 month</span>.</li>
      <li>Access to our closed Beta.</li>
      <li>5 invites to our closed Beta.</li>
    </ul>
  </div>
  <a href="#TierTwo" onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut} className="fund-cta">Contribute</a>
  </div>
</div>
